...
public class Parser {
	      ...
	      while( look.tag == Tag.BASIC ) {   // D -> type ID ;
	         ...
	         if(look.tag == Tag.ID){
				 ...
				 if(top.get(tok)==null)
					 ...
					 System.out.println("near line :"+lex.line+" :id "+tok.toString()+" has been declared more than once.");
				 }
				 used = used + p.width;
	         }
	         else{
				 System.out.println("near line :"+lex.line+" identifiers error");
			 }
	         match(';');
	   ...
	   Expr equality() throws IOException {
	      ...
	      if(look.toString().equals("=")) {
	      	...
	      	System.out.println("near line "+lex.line+" :The type of a condition expression is not bool");
